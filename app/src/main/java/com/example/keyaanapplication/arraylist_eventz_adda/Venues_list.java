...
public class Venues_list {
    private String resort_name, review_count,location_name,price_plate,rating;
    private int location_image;



    public Venues_list(String resort_name,String review_count,String location_name,String price_plate, int location_image, String rating) {
