...
public class Entertainment_List {
    ...
    public Entertainment_List(String resort_name,String review_count,String location_name,String price_plate, int location_image, String rating) {
