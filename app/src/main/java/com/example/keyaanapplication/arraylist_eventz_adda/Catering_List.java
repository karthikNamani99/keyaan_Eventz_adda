...
public class Catering_List {
    private String resort_name, review_count,location_name,price_plate,rating;
    private int location_image;



    public Catering_List(String resort_name,String review_count,String location_name,String price_plate, int location_image, String rating) {
