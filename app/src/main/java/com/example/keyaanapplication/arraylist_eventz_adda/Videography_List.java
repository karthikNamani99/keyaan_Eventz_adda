...
public class Videography_List {
    ...
    public Videography_List(String resort_name,String review_count,String location_name,String price_plate, int location_image, String rating) {
