...
import com.example.keyaanapplication.adapters.Entertainment_Adapter;
...
public class Entertainment_Activity extends Activity implements View.OnClickListener {
    private List<Entertainment_List> eventList1 = new ArrayList<>();
    private RecyclerView recyclerView;
    private Entertainment_Adapter mAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.entertainment_main);


        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);

        mAdapter = new Entertainment_Adapter(eventList1,this);
        ...
        editTextSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                final List<Entertainment_List> filteredList = new ArrayList<>();
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(Entertainment_Activity.this));
                mAdapter = new Entertainment_Adapter(filteredList, Entertainment_Activity.this);
                recyclerView.setAdapter(mAdapter);
    ...
    private void prepareEventsData() {
        ...
        Entertainment_List event1 = new Entertainment_List("Courtyard by Marriott Pune City ...", "1 Review", "Pune", "1000 per plate", R.drawable.img1, "5.0");
        eventList1.add(event1);

        event1 = new Entertainment_List("Courtyard by Marriott Pune City ...", "1 Review", "Pune", "1000 per plate", R.drawable.img1, "5.0");
        eventList1.add(event1);
