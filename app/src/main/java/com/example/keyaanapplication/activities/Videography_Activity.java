...
import com.example.keyaanapplication.adapters.Videography_Adapter;
...
public class Videography_Activity extends Activity implements View.OnClickListener {

    private List<Videography_List> eventList1 = new ArrayList<>();
    private RecyclerView recyclerView;
    private Videography_Adapter mAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.videography_main);


        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);

        mAdapter = new Videography_Adapter(eventList1,this);
        ...
        editTextSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                final List<Videography_List> filteredList = new ArrayList<>();
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(Videography_Activity.this));
                mAdapter = new Videography_Adapter(filteredList, Videography_Activity.this);
                recyclerView.setAdapter(mAdapter);
    ...
    private void prepareEventsData() {
        ...
        Videography_List event1 = new Videography_List("Courtyard by Marriott Pune City ...", "1 Review", "Pune", "1000 per plate", R.drawable.img1, "5.0");
        eventList1.add(event1);

        event1 = new Videography_List("Courtyard by Marriott Pune City ...", "1 Review", "Pune", "1000 per plate", R.drawable.img1, "5.0");
        eventList1.add(event1);
