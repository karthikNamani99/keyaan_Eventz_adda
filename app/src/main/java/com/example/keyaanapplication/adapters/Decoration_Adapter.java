...
public class Decoration_Adapter extends RecyclerView.Adapter<Decoration_Adapter.MyViewHolder> {
    private List<Decoration_List> eventList1 ;
    private Context context;

    public Decoration_Adapter(List<Decoration_List> events, Context mContext) {
...
//    }
    ...
    @Override
    public Decoration_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.decorations_listitems_main, parent, false);

        Decoration_Adapter.MyViewHolder myViewHolder = new Decoration_Adapter.MyViewHolder(itemView);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(Decoration_Adapter.MyViewHolder holder, int position) {
        Decoration_List event = eventList1.get(position);
